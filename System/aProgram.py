...
linguagem = "English (EUA)"
tamanhosistema = 0.41
restart = " restart"
check = " check"
ready = " ready"
# Variáveis do Root do sistema
root = ["open sys", "open apps", "open store", "open about", "open help", "open tools", "open system", "open errors",
        "open infos", "open cal", "open * in system"]
rootoff = ["close sys", "close apps", "close store", "close about", "close help", "close tools", "close system",
           "close errors", "close infos", "close cal", "close * in system"]
# creatorsy
creator = "@Victor_Elias2"
...
if nome == "admin":
    ...
    if iniciosy == "off":
        ...
        print(
            "This is a MS-DOS simulator, so he has a calculator, you can view date and hour, see messages in the aDreamWorld program, and open limited files on your computer like Google Chrome, Notepad and Internet Explorer.")
        time.sleep(15)
        print("Exiting...")
        quit()
        ...
        while iniciosy == "addex" or iniciosy == "start addex" or iniciosy == "start aProgram":
            ...
            # Adicionar um sistema de áudio para essa parte, para funcionar tipo alarme.
            elif inicio == "psc":
                note = input("Reminder to me (Note): ")
                ...
                if config == "change name":
                    ...
                    if len(mudanovo_nome) == 0:
                        print("It's going wrong, try again with another name.")
                    else:
                        time.sleep(0.2)
                        nome = mudanovo_nome
                        print("Ready!")
                    ...
                    if len(aplicativos) >= 1:
                        ...
                        while True:
                            ...
                            if aplicativos[x] == per:
                                ...
                                print(
                                    "This program does not exist! Please download new programs \n with the command 'store'!")
                                break
                            x += 1
                    else:
                ...
                print(
                    "The code 'psc' is used to put a message on the screen and say how many seconds it will be exposed.")
                ...
                print("To install: ")
                print(
                    "To install a program, you have to go on store and type:\n'install [program name]' wait for download and ready!")
                separador()
                print("To uninstall: ")
                print(
                    "To uninstall a program, you have go to '-->' and type 'uninstall [program name]' wait for uninstall and ready!")
                separador()
